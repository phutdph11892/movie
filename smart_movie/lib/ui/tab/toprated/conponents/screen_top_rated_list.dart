...
import 'item_toprated.dart';



class ScreenTopRatedList extends GetWidget<TopRatedListController> {
  @override
  final TopRatedListController controller = Get.put(TopRatedListController());

  ScreenTopRatedList({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Ink(
        color: Colors.grey,
        child: GetBuilder<TopRatedListController>(
  ...
  Widget buildListView(TopRatedListController s) {
  ...
  // Widget buildListView1(TopRatedListController s) {
  //   var isLoadMore = s.isLoadingMore.value;
  //   int totalItem = s.movies.length;
  //   if (totalItem != 0) {
  //     return Column(
  ...
  // }
  //
  // Widget buildMovieCardView(TopRatedListController s, int index) {
