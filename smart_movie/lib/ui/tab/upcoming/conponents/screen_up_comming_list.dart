...
class ScreenUpCommingList extends GetWidget<UpCommingListController> {
  @override
  final UpCommingListController controller = Get.put(UpCommingListController());

  ScreenUpCommingList({Key? key}) : super(key: key);
  ...
  Widget buildMovieCardView(UpCommingListController s, int index) {
